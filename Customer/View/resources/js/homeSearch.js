      ...
      success: function (res) {
        ...
        for (const search_product of search_products) {
          ...
          $("#home_main_section").append(
            ` <a href="./detailpage.php?productid=${search_product["id"]}" class="lg:w-56 w-40 lg:h-72 h-60 bg-white drop-shadow-md mt-8 group products_to_add rounded-lg" id ="${search_product["id"]}">
