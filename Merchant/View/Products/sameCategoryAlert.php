...
<body>
    ...
    <div class="ml-36 px-10 py-2 flex flex-col justify-center items-center mb-10 mt-28">
                ...
                <h3 class="font-bold text-orange text-2xl ">Category Already exists</h3>

                <div class="mt-10">
                    <a href="../Products/categoryAdd.php"><button type="button" class="px-5 py-1 text-button rounded-lg bg-inputBox border border-button  text-xl font-RobotoSlab shadow-sm hover:bg-orange hover:text-whiteText hover:border-0 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange">OK</button></a>
                </div>
