$(document).ready(function () {
  $(document).on("click", ".subCat", function () {
    ...
    $.ajax({
      url: "../../Controller/searchSubcategoryController.php",
      type: "POST",
      data: {
        subCategoryId: $(this).find("p").text(),
      },
      success: function(res) {
          ...
          for (const product of products) {
             $("#searchResult").append(
              ...
              <img class="rounded-t-lg" src=" ../../..${product.p_photo_1}"
              ...
              <div class="px-5 pb-5">
                  <a href="#" class="">
                      <h5 class="mt-5 text-md font-semibold tracking-tight text-blueText dark:text-white">${product.p_title}</h5>
                  </a>
                  ...
                  <div class="flex items-center justify-between">
                      <span class="text-xl font-bold text-blueText dark:text-white">${product.p_sell_price}Ks</span>
